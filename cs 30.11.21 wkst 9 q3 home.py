...
# Menu
    ...
    if user < 0 or user > 9:
        ...
        while counter:
            print('*******************************************')
            print('Option 4: Modify an existing element')
            print('*******************************************')
            print()
            
            print(default_list)
            user_element_modify = input('Enter the element you want to modify: ')
            print()
            input_modify = input('Enter what you would like the element to be modified to: ')
            
            location_user_element = default_list.index(user_element_modify)
        
            print('List before operation: ', default_list)
            del default_list[location_user_element]
            default_list.insert(location_user_element,input_modify)
            print('List after operation: ' , default_list)
